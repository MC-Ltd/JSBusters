...
Коротка відповідь: “властивості впорядковані особливим чином”. Властивості з цілочисельними ключами сортуються за зростанням, інші розташовуються в порядку створення.

[uk.javascript.info](https://uk.javascript.info/object#vporyadkuvannya-vlastivostei-obyekta)
:::
...
::: info Переклад
Порядок обходу, згідно з сучасною специфікацією ECMAScript, є чітко визначеним та послідовним у всіх реалізаціях. У кожному компоненті ланцюжка прототипів усі невід'ємні цілочисельні ключі (ті, що можуть бути індексами масиву) будуть обходитися спочатку у порядку зростання за значенням, потім інші рядкові ключі у зростаючому хронологічному порядку створення властивості.
:::
...
::: info Переклад
... **Масиви JavaScript мають "нульовий індекс"**: перший елемент масиву має індекс 0, другий - індекс 1 тощо, а останній елемент має значення властивості масиву `length` мінус 1.
:::
...
<br><br>
... Встановлення будь-якого індексу масиву (невід’ємне ціле число менше за 2<sup>32</sup>) понад поточну `length` розширює масив — властивість `length` збільшується, щоб відобразити новий найвищий індекс.
:::
...
::: info Переклад
Максимально допустима довжина масиву залежить від платформи, браузера та версії браузера. Для масиву максимальна довжина становить (2<sup>32</sup> - 1).
:::
...
пісочниці: [Node.js](https://onecompiler.com/nodejs/44tcqbczq), [Deno](https://onecompiler.com/deno/44tcqb6mk), [Bun](https://onecompiler.com/bun/44tcqarcw), [DevTools](/uk/faq#DevTools), [console](/uk/faq#console)
